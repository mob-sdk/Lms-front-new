...
class Course(UrlMixin, models.Model):
    ...
    url = models.CharField(unique=True, max_length=255, blank=False,
        ...
        help_text=_("Input an URL identifier for this course."), verbose_name=_('Urlidentifier'))
    teachers = models.ManyToManyField(UserProfile,
        related_name="teaching_courses", blank=True, verbose_name=_('teachers'))
...
#     slug='user-internal',
#     description=_(
#         "The user profile contains a student number and has logged in via local organisation authentication"),
#     color='#006cb4',
# )
#
#
...
class CourseInstance(UrlMixin, models.Model):
    ...
    url = models.CharField(max_length=255, verbose_name='URL标识', blank=False,
        validators=[generate_url_key_validator()],
        help_text=_("Input an URL identifier for this course instance."))
    visible_to_students = models.BooleanField(default=True, verbose_name='公开课程')
    ...
    lifesupport_time = models.DateTimeField(blank=True, null=True, verbose_name='结业时间')
    archive_time = models.DateTimeField(blank=True, null=True, verbose_name='归档时间')
    enrollment_starting_time = models.DateTimeField(blank=True, null=True, verbose_name='开放注册时间')
    enrollment_ending_time = models.DateTimeField(blank=True, null=True, verbose_name='关闭注册时间')
    image = models.ImageField(blank=True, null=True, upload_to=build_upload_dir, verbose_name='缩略图')
    language = models.CharField(max_length=255, blank=True, default="zh-hans", verbose_name='语言')
    description = models.TextField(blank=True, verbose_name='描述')
    footer = models.TextField(blank=True, verbose_name='页脚')
    index_mode = models.IntegerField(choices=INDEX_TYPE.choices, default=INDEX_TYPE.RESULTS, verbose_name=_('Index mode'),
    ...
    content_numbering = models.IntegerField(choices=CONTENT_NUMBERING.choices,
                                            default=CONTENT_NUMBERING.ARABIC,
                                            verbose_name='章节编号')
    head_urls = models.TextField(blank=True, verbose_name='资源URLs',
    ...
    technical_error_emails = models.CharField(max_length=255, blank=True, verbose_name='错误邮箱',
    ...
    assistants = models.ManyToManyField(UserProfile, related_name="assisting_courses", verbose_name='选择助教',blank=True)
...
class CourseModule(UrlMixin, models.Model):
    ...
    status = models.CharField(max_length=32,
                              choices=STATUS.choices, default=STATUS.READY, verbose_name='当前状态')
    order = models.IntegerField(default=1, verbose_name='序号')
    name = models.CharField(max_length=255, verbose_name='名称')
    url = models.CharField(max_length=255,
                           validators=[generate_url_key_validator()],
                           help_text=_("Input an URL identifier for this module."), verbose_name='utl标识符')
    points_to_pass = models.PositiveIntegerField(
        default=0, verbose_name='通过分数')
    introduction = models.TextField(blank=True, verbose_name='描述')
    course_instance = models.ForeignKey(CourseInstance, on_delete=models.CASCADE,
                                        related_name="course_modules", verbose_name='课程实例')
    opening_time = models.DateTimeField(
        default=timezone.now, verbose_name='课程开放时间')
    closing_time = models.DateTimeField(
        default=timezone.now, verbose_name='课程结束时间')
    ...
    late_submissions_allowed = models.BooleanField(
        default=False, verbose_name='是否允许逾期提交')
    late_submission_deadline = models.DateTimeField(
        default=timezone.now, verbose_name='逾期提交截止时间')
    late_submission_penalty = PercentField(default=0.5,
                                           help_text=_("Multiplier of points to reduce, as decimal. 0.1 = 10%"), verbose_name='逾期提交惩罚')
...
class LearningObjectCategory(models.Model):
    ...
    status = models.CharField(max_length=32,
        choices=STATUS.choices, default=STATUS.READY, verbose_name=_('Status'))
    name = models.CharField(max_length=255,verbose_name=_('name'))
    description = models.TextField(blank=True, verbose_name=_('Description'))
    points_to_pass = models.PositiveIntegerField(default=0, verbose_name=_('Points_to_pass'))
    course_instance = models.ForeignKey(CourseInstance, on_delete=models.CASCADE,
        related_name="categories", verbose_name=_('Course_instance'))
    confirm_the_level = models.BooleanField(default=False,
        help_text=_("Once exercise is graded non zero it confirms all the points on the hierarchy level. Implemented as a mandatory feedback feature."), verbose_name=_('Confirm_the_level'))
    accept_unofficial_submits = models.BooleanField(default=False,
        help_text=_("Grade unofficial submissions after deadlines have passed or submission limits have been exceeded. The points are stored but not included in official records."), verbose_name=_('Accept_unofficial_submits'))
