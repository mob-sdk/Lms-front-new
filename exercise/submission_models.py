...
class Submission(UrlMixin, models.Model):
    ...
    submission_time = models.DateTimeField(
        auto_now_add=True, verbose_name='提交日期')
    ...
    assistant_feedback = models.TextField(blank=True, verbose_name='助教反馈')
    status = models.CharField(max_length=32,
                              choices=STATUS.choices, default=STATUS.INITIALIZED, verbose_name='状态')
    ...
    late_penalty_applied = PercentField(
        blank=True, null=True, verbose_name='逾期扣分适用')
