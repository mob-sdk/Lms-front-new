...
from exercise.models import Submission, LearningObject
from userprofile.models import UserProfile
from exercise.field import ListTextWidget
...
class SubmissionReviewForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # same list.
        self.fields['assistant_feedback'].widget = ListTextWidget(data_list=_country_list, name='country-list')
...
class exercise_comments(forms.Form):
    comments = forms.CharField(required=False, widget=forms.Textarea, label='评论', initial='请输入内容')
