...
urlpatterns = [
    ...
    url(EXERCISE_URL_PREFIX + r'commentreply/(?P<parent_id>[\d]+)$',
        views.exerciseCommentsReplyView.as_view(),
        name="exercise-comments-reply"),
    url(EXERCISE_URL_PREFIX + r'comment/$',
        views.exerciseCommentsView.as_view(),
        name="exercise-comments"),
