...
WELCOME_TEXT = '虚拟仿真实验教学平台<small>——基于区块链的大型开放式网络课程平台</small>'
...
INTERNAL_USER_LABEL = '线下学员'
EXTERNAL_USER_LABEL = '线上学员'
...
INSTALLED_APPS = (
    ...
    'debug_toolbar',                # django debug tools
...
MIDDLEWARE = [
    'debug_toolbar.middleware.DebugToolbarMiddleware', # django debug tools
...
SESSION_COOKIE_NAME = "sessionnumber"  # 这是自定义session的名称
