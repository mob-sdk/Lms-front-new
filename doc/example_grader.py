    ...
    def do_POST(self):
        ...
        if '/first_exercise/' in self.path:
            ...
            response = '<html><head>\n' +\
                       ...
                       '提交成功，  你已答对 ' + str(points) + '/' +\
                       str(max_points)+ ' 个计分点!</div></body></html>'
            self._respond(response.encode('utf-8'))
        ...
        #       We will now send the score to A+ using the submission URL.
            ...
            request_dict = {
                ...
                'feedback': '你将获得 %s / %s 对于你的答案' % (points, max_points),
                'grading_payload': '{}'
            }
        ...
        # Demonstrating hook functionality
            ...
            response = '<html><body><p>POST Hook 检测到!</p><ul>\n'
